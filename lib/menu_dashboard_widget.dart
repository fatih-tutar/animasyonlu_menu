  ...
  Widget dashBoardOlustur(BuildContext context) {
    return AnimatedPositioned(
      ...
      child: ScaleTransition(
        ...
        child: Material(
          borderRadius:
              menuAcikMi ? BorderRadius.all(Radius.circular(20)) : null,
          elevation: 8,
          color: backgroundColor,
          child: SingleChildScrollView(
            child: Container(
              padding: EdgeInsets.only(left: 16.0, right: 16, top: 8.0),
              child: Column(
                children: <Widget>[
                  Row(
                  ...
                  Container(
                    ...
                    child: PageView(
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          child: Image.network(
                              "https://flashresim.com/blog/wp-content/uploads/2018/11/manzara-resim.jpg",
                              fit: BoxFit.cover),
                          width: 200,
                          margin: EdgeInsets.symmetric(horizontal: 2),
                        ),
